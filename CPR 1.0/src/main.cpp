...
// Firebase paths
const String listenerPath = "/actions/mohamed amine/action";
const String tokenPath = "/actions/mohamed amine/token";
const String dosePath = "/actions/mohamed amine/dose";
...
void update_status(String status)
{
  if (Firebase.RTDB.setString(&fbdo_set, "/actions/mohamed amine/status",status)) {
...
void update_IP(String IP)
{
  if (Firebase.RTDB.setString(&fbdo_set, "/actions/mohamed amine/machineIP",IP)) {
...
{
  float dose;
  if (Firebase.RTDB.getString(&fbdo_set, "/actions/mohamed amine/dose")) 
    {
...
{
  String token;
  if(Firebase.RTDB.getString(&fbdo_set, "/actions/mohamed amine/token")) 
    {
